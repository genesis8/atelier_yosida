...
[func_face_show name="youmu"]
10万円の貯金を作るのに、どれだけ働かなければいけないか…[p]
...
これは上から順にお店の汚れ、お店の人気、経験値、ヨシダさんの精神力[p]
となっています。まぁ…遊んでいけば分かるでしょう…[p]
役割は割愛しますね。[p]
それと、その右上にある『EMPTY』と書かれたものが倉庫の空き具合です。[p]
倉庫の空き具合とは、あとどれだけ商品を仕入れることができるのか？[p]
を表したものです。[p]
今の数値が30ですので、うちのお店には、[p]
あと30個の商品を仕入れることができる…[p]
ということですね。[p]
...
これらは利益の少ない商品ばかりです。[p]
市場を利用したり、XXXXたちを使って、[p]
質の高い商品を集めるよう、努力してください。[p]
[func_face_hide name="youmu"]
